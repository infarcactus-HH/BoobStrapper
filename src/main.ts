...
class Userscript {
  constructor() {
    ...
    unsafeWindow.BoobStrapperConfig = unsafeWindow.hhPlusPlusConfig;
    unsafeWindow.BoobStrapper = unsafeWindow.HHPlusPlus;
  ...
  addConfigToggles() {
    ...
    this.$settingsButton = $(
      `<div class="hh-plus-plus-config-button" hh_title="BoobStrapper" tooltip=""></div>`
    ).on("click", () => {
  ...
  generateConfigPannel() {
    ...
    this.$configPannel = $(`<div class="hh-plus-plus-config-panel shown">`);
